...
(function(w) {
    ...
    function shareText(cps) {
        ...
        if (cps <= 11)  return I18N['text-level-3'];
        if (cps <= 14) return I18N['text-level-4'];
        if (cps <= 18) return I18N['text-level-5'];
        if (cps <= 20) return I18N['text-level-6'];
        return I18N['text-level-7'];
    }
